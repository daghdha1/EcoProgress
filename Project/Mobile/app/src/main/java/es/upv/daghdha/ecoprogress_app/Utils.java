...
// -----------------------------------------------------------------------------------
// @author: Jordi Bataller i Mascarell y EcoProgress Team 04
// -----------------------------------------------------------------------------------
public class Utils {
    ...
    public static UUID stringToUUID(String uuid) {
        ...
        UUID res = new UUID(Utils.bytesToLong(masSignificativo.getBytes()), Utils.bytesToLong(menosSignificativo.getBytes()));
    ...
    public static String uuidToString(UUID uuid) {
        return bytesToString(twoLongToBytes(uuid.getMostSignificantBits(), uuid.getLeastSignificantBits()));
    } // ()

    // -------------------------------------------------------------------------------
    // -------------------------------------------------------------------------------
    public static String uuidToHexString(UUID uuid) {
        return bytesToHexString(twoLongToBytes(uuid.getMostSignificantBits(), uuid.getLeastSignificantBits()));
    } // ()
    ...
    // -------------------------------------------------------------------------------
    // -------------------------------------------------------------------------------
    public static byte[] twoLongToBytes(long masSignificativos, long menosSignificativos) {
    ...
    // -------------------------------------------------------------------------------
    // -------------------------------------------------------------------------------
    public static String bytesToIntInStr(byte[] bytes) {
        if (bytes == null) {
            return "";
        }
        ...
        StringBuilder sb = new StringBuilder();
        for (byte b : bytes) {
            sb.append(String.format(Locale.getDefault(), "%d", b));
            sb.append(':');
        }
        return sb.toString();
    }
